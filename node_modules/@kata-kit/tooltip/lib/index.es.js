...
var Tooltip = (function (_super) {
    ...
    Tooltip.prototype.render = function () {
        var _a = omit(this.props, [
            ...
            'arrowOffsetTop',
            'arrowOffsetLeft'
        ]), placement = _a.placement, className = _a.className, show = _a.show, children = _a.children, targetNodePosition = _a.targetNodePosition, props = __rest(_a, ["placement", "className", "show", "children", "targetNodePosition"]);
        var arrowStyles = {};
        if ((placement === 'right' || placement === 'left') &&
            targetNodePosition.top) {
            arrowStyles.top = Math.ceil(targetNodePosition.top - props.style.top) + "px";
        }
        if ((placement === 'top' || placement === 'bottom') &&
            targetNodePosition.left) {
            arrowStyles.left = Math.ceil(targetNodePosition.left -
                props.style.left -
                targetNodePosition.width / 2) + "px";
        }
        return (createElement(Theme, null, function (themeAttributes) { return (createElement(Root, __assign({ role: "tooltip", show: show }, props),
            createElement(Inner, null, children))); }));
    };
...
var isExists = function (needle, haystack) {
...
var composeFunctions = function () {
    ...
    var validFuncs = filter(funcs, function (f) { return f !== null || f === 'function'; }).filter(function (f) { return f; });
    return flowRight(validFuncs);
};
var TooltipTarget = (function (_super) {
    __extends(TooltipTarget, _super);
    function TooltipTarget(props) {
        var _this = _super.call(this, props) || this;
        _this.handleDelayedHide = function () {
            if (_this.hoverShowDelay != null) {
                clearTimeout(_this.hoverShowDelay);
                _this.hoverShowDelay = null;
                return;
            }
            if (!_this.state.show || _this.hoverHideDelay != null) {
                return;
            }
        ...
        _this.handleDelayedShow = function () {
            if (_this.hoverHideDelay != null) {
                clearTimeout(_this.hoverHideDelay);
                _this.hoverHideDelay = null;
                return;
            }
            if (_this.state.show || _this.hoverShowDelay != null) {
                return;
            }
        ...
        _this.renderOverlay = function () {
            unstable_renderSubtreeIntoContainer(_this, _this.overlay, _this.node);
        };
        _this.state = {
        ...
        _this.createOverlay = _this.createOverlay.bind(_this);
    ...
    TooltipTarget.prototype.componentDidMount = function () {
        this.node = document.createElement('div');
        this.targetNodePosition = findDOMNode(this).getBoundingClientRect();
        this.renderOverlay();
    };
    TooltipTarget.prototype.componentDidUpdate = function () {
        this.renderOverlay();
    };
    TooltipTarget.prototype.componentWillUnmount = function () {
        unmountComponentAtNode(this.node);
        this.node = null;
        clearTimeout(this.hoverShowDelay);
        clearTimeout(this.hoverHideDelay);
    };
    TooltipTarget.prototype.handleToggle = function () {
        if (this.state.show) {
            this.hide();
        }
        else {
    ...
    TooltipTarget.prototype.handleMouseOverOut = function (handler, e, relatedNative) {
    ...
    TooltipTarget.prototype.show = function () {
        this.setState(__assign({}, this.state, { show: true }));
    };
    TooltipTarget.prototype.hide = function () {
        this.setState(__assign({}, this.state, { show: false }));
    };
    TooltipTarget.prototype.createOverlay = function (component, overlayProps) {
        return (createElement(Overlay, { show: this.state.show, target: this, placement: overlayProps.placement }, cloneElement(component, __assign({}, overlayProps, { show: this.state.show, targetNodePosition: this.targetNodePosition }))));
    };
    TooltipTarget.prototype.render = function () {
        var _a = omit(this.props, ['defaultShow']), children = _a.children, component = _a.component, trigger = _a.trigger, onClick = _a.onClick, onMouseOver = _a.onMouseOver, onMouseOut = _a.onMouseOut, onFocus = _a.onFocus, onBlur = _a.onBlur, props = __rest(_a, ["children", "component", "trigger", "onClick", "onMouseOver", "onMouseOut", "onFocus", "onBlur"]);
        ...
        return cloneElement(childElement, childTrigger);
    };
