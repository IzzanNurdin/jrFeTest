...
var Drawer = (function (_super) {
    ...
    Drawer.prototype.render = function () {
        var _this = this;
        var wrapper = (createElement(Fragment, null,
            this.props.backdrop && (createElement(DrawerOverlay, { className: classnames(this.state.isOpen && 'is-open'), onClick: this.props.backdrop === true ? this.onCloseDrawer : undefined })),
            createElement(Theme, { values: theme }, function (themeAttributes) { return (createElement(DrawerWrapper, { "data-testid": "Drawer-wrapper", theme: themeAttributes, className: classnames(_this.state.isOpen ? 'is-open' : 'is-closed', _this.props.className), role: "dialog", "aria-modal": "true", "aria-labelledby": _this.props.labelledById },
                createElement(FocusTrap, { active: _this.state.isOpen, onKeyDown: _this.handleKeyDown },
                    createElement(DrawerContext.Provider, { value: _this.getContextAPI() }, _this.state.isOpen && _this.props.children)))); })));
...
var DrawerBody = function (_a) {
    ...
    return (createElement(DrawerContext.Consumer, null, function (api) { return (createElement(Scrollbars, { onScrollFrame: function (scroll) { return api.watchOverflow(scroll.top); } },
...
var DrawerHeader = function (_a) {
    ...
    return (createElement(DrawerContext.Consumer, null, function (api) { return (createElement(DrawerHeading, { className: classnames(api.overflow && 'is-overflow', className) },
        createElement(DrawerHeadingWrapper, null,
            createElement(DrawerTitle, { id: api.labelledById }, title),
            createElement(Button, { "data-testid": "DrawerHeader-closeButton", isIcon: true, onClick: api.onClose },
...
var DrawerFooter = function (props) { return (createElement(Theme, { values: theme }, function (themeAttributes) { return createElement(Root$1, { theme: themeAttributes }, props.children); })); };
